...
[**Live Example**](https://anthonyomorada.github.io/anthony-morada-cv/) \| [**Quick Start Guide**](#-quick-start)
...
**Popular academic colors:** - `#2c5aa0` - Professional Blue (default) - `#1a472a` - Medical Green\
